...
select
    ...
    case 
        when shortage_status = 'new' then '#ff4444'
        when shortage_status = 'continued' then '#ff8800'  
        when shortage_status = 'ended' then '#44ff44'
        when shortage_status = 'discontinued' then '#888888'
        else '#cccccc'
    end as status_color
